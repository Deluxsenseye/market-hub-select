...
import { ShoppingCart, FileImage, User, Plus, Minus } from "lucide-react";
...
const PublicStore = () => {
  ...
  useEffect(() => {
    ...
    if (company) {
      ...
      // Aplicar el color primario de la empresa
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-600">Empresa no encontrada</h1>
                ...
                <CardContent>
                  ...
                  >
                    {product.stock === 0 ? "Sin Stock" : 
                     cartQuantity > 0 ? "Agregar Más" : "Agregar al Carrito"}
                  </Button>
                </CardContent>
              </Card>
            );
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Button className="md:col-span-2">Enviar Consulta</Button>
            </div>
          </CardContent>
        </Card>
      </div>
